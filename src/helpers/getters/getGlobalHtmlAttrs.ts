import type { AllHTMLAttributes, AriaAttributes, InputHTMLAttributes, SelectHTMLAttributes, TextareaHTMLAttributes } from 'react'
...
type Role = {
  role?: (
    ...
    | 'list' | 'listitem' | 'region' | 'row' | 'toolbar' | 'note' | 'separator'
    // Landmark Roles
